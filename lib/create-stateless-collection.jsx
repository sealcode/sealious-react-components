...
function createStatelessQueryCollection(params) {
	...
	return React.createClass({
		...
		refresh: function() {
			...
			//timeout is needed here because cancellation callback in CachedHttp are handled asynchronously, so if we
			//ran CachedHttp without delegation it would consume a cancelled promise
			setTimeout(() => {
